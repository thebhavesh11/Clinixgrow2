@echo off
title FlowBot AI - Clean Start
echo.
echo  ============================================
echo    FlowBot AI - Clean Start (New DB)
echo  ============================================
echo.

:: Delete old database
echo [0/4] Deleting old database...
if exist "%~dp0backend\smartflow.db" (
    del /q "%~dp0backend\smartflow.db"
...
start "FlowBot-WhatsApp" cmd /c "cd /d "%~dp0whatsapp-bridge" && node index.js"
timeout /t 2 >nul

:: Start Frontend (Next.js)
echo [4/4] Starting Frontend (port 3000)...
start "FlowBot-Frontend" cmd /c "cd /d "%~dp0frontend" && npm run dev"
timeout /t 3 >nul
