...
async def get_dashboard(db: AsyncSession = Depends(get_db)):
    """Get dashboard analytics. Returns zeroed response on error — dashboard should never crash."""
    try:
        ...
        # Return zeroed response instead of crashing — dashboard is non-critical
        return DashboardResponse()
